function SearchForPIPoint() {
    ...
    return $.ajax({
        url: 'https://localhost:44310/Home/SearchPIPoint?PointName=' + pointname + '',
        type: 'GET',
...
function ShowPiPointDetails(event)
{
    ...
    return $.ajax({
        url: 'https://localhost:44310/Home/Recorded?WebId=' + webId + '&StartTime=' + starttime + '&EndTime=' + endtime + '',
        type: 'GET',
        contentType: 'application/json; charset=UTF-8',
        async: true,
        datatype: 'json',
