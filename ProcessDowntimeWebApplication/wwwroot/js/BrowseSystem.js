function SystemTree()
{
    $("#mydb").empty();
    return $.ajax({
        url: 'https://localhost:44310/Home/Analyses?WebId=F1EmcegbpJtv7kKlF5s1SRObWgPwOMDRR-6RGp89Qli5iTwwTUdQUElBRjAxXEFNQkFUT1ZZIFJFUE9SVElOR1xET1dOVElNRQ',
        type: 'GET',
        ...
        error: function (xhr) {
            alert("Error on loading the system tree!...probably a license issue, please contact the youremail@company.com")
            return;
        },
    });
}
function BrowseAf(event)
{
    ...
    if ($("#" + WebId + "").children().length > 0 && $("#" + WebId + "").children().is(":visible") == true) {
        ...
        return $.ajax({
            url: 'https://localhost:44310/Home/Analyses?WebId=' + WebId + '',
            type: 'GET',
            contentType: 'application/json',
            async: true,
            datatype: 'json',
...
function BrowseAfAttributes(WebId)
{
    ...
    $("#attributes").empty();
            return $.ajax({
            url: 'https://localhost:44310/Home/Attributes?WebId=' + WebId + '',
            type: 'GET',
            contentType: 'application/json',
            async: true,
            datatype: 'json',
...
function BrowseAfConfigAnalyses(WebId) {
    $("#config").empty();
    return $.ajax({
        url: 'https://localhost:44310/Home/ConfigAttributes?WebId=' + WebId + '',
        type: 'GET',
        contentType: 'application/json',
        async: true,
        datatype: 'json',
