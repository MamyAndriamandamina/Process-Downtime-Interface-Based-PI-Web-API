...
{   
    return $.ajax({
        url: 'http://mgppiaf01:44310/Home/PIEnumerationSets?EnumerationTarget='+EnumerationTarget+'',
        type: 'GET',
        ...
        error: function (xhr)
        {
            alert("Error on loading the enumerations sets!..., please contact PIHelp@ambatovy.mg")
            return;
        },
    });
}
function BrowseEnumerationValue(EnumerationTarget, WebId) {
    ...
    return $.ajax({
        url: 'http://mgppiaf01:44310/Home/PIEnumerationValues?WebId=' + WebId + '',
        type: 'GET',
        contentType: 'application/json',
        async: true,
        datatype: 'json',
        ...
        error: function (xhr) {
            alert("Error on loading the enumerations values!..., please contact PIHelp@ambatovy.mg")
            return;
        },
    });
}
