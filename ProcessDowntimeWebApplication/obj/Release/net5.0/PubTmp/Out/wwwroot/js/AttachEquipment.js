...
function SearchEquipment() {
    ...
    return $.ajax({
        url: 'http://mgppiaf01:44310/Home/ElementSearch?ElementName=' + element + '',
        type: 'GET',
            ...
            if (!$.trim(Data)) {
                ...
                try {
                    ...
                    for (i = 0; i < str.length; i++) {
                        ...
                        var mini_path = replaceAll(path, "\\\\MGPPIAF01\\Ambatovy Process Downtime\\", "");
                        ...
                        var body = '<tbody class="table-bordered"><tr>'
                            ...
                            + '<th>' + description + '</th>'
                            + '<th>' + mini_path + '</th>'
                            + '<th>' + '<a onclick=\"AttachEquipment(event)\" id="' + name + "|" + mini_path + '" class=\"btn btn-success\" data-dismiss=\"modal\"> <span class=\"glyphicon glyphicon-tags\"></span>Attach</a>' + '</th>'
                            + '<tr></tbody>';
